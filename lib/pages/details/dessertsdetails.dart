...
class Desserts_RecipeDetails extends StatefulWidget {
  final Map<String, dynamic> recipeData;

  Desserts_RecipeDetails({required this.recipeData});

  @override
  State<Desserts_RecipeDetails> createState() => _Desserts_RecipeDetailsState();
}

class _Desserts_RecipeDetailsState extends State<Desserts_RecipeDetails> {
                          ...
                          children: [
                            IconButton(
                              icon: Icon(Icons.share,
                                  color: Colors.teal[400], size: 24),
                              onPressed: (){Share.share("https://play.google.com/store/apps/details?id=com.synergyuniversal.receptoria1&pcampaignid=web_share");},    
                            ),
