...
class NonVeg_RecipeDetails extends StatefulWidget {
  final Map<String, dynamic> recipeData;

  NonVeg_RecipeDetails({required this.recipeData});

  @override
  State<NonVeg_RecipeDetails> createState() => _NonVeg_RecipeDetailsState();
}

class _NonVeg_RecipeDetailsState extends State<NonVeg_RecipeDetails> {
