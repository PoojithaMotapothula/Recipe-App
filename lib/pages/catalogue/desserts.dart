...
import 'package:receptoria1/pages/details/dessertsdetails.dart';
...
class _DessertsState extends State<Desserts> {
              ...
              builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
                ...
                List<Widget> recipeWidgets = snapshot.data!.docs.map((doc) {
                  ...
                  return GestureDetector(
                    onTap: () {
                      onCardTapped(data); // Navigate to details page
                    },
                    child: Card(
                      elevation: 5,
  ...
  void onCardTapped(Map<String, dynamic> recipeData) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => Desserts_RecipeDetails(recipeData: recipeData),
      ),
    );
  }
}
